...
export default function DisclaimerPage() {
  return (
    ...
    >
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B132B]">HELPER и автоматизация</h2>
        <p className="mt-2">
          Ассистент HELPER внутри калькулятора помогает проставить параметры из
          текстового ТЗ. Это интерфейсный помощник, а не экспертное заключение и
          не замена инженеру. Ответственность за применение цифр остаётся на
          пользователе и проектировщике объекта.
        </p>
      </section>
      <section>
